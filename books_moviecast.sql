...
CREATE TABLE `moviecast` (
  ...
  KEY `movieid` (`movieid`),
  CONSTRAINT `moviecast_ibfk_1` FOREIGN KEY (`actid`) REFERENCES `actor` (`actid`),
  CONSTRAINT `moviecast_ibfk_2` FOREIGN KEY (`movieid`) REFERENCES `movies` (`movieid`)
...
INSERT INTO `moviecast` VALUES (1,1,'chief brody'),(2,2,'rose dewitt bukater'),(3,3,'vincent vega'),(4,4,'andy dufresne'),(5,5,'LEAD');
